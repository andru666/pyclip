...
class Scenarii(App):
    ...
    def sondeO(self, instance):
        ...
        for etat in self.ScmList_Etats:
            ...
            if value1 != pyren_encode( mod_globals.language_dict[etat['RefOK']] ):
                ...
                self.layout.add_widget(MyLabel(text='', height=fs*0.1, size_hint=(1, 1), bgcolor=(1, 0, 1, 0.3)))
        ...
        self.popup_open(self.get_message('TexteSousTitre'), self.layout, Window.size[0], Window.size[1])
    ...
    def popup_open(self, title, message, S1=None, S2=None):
        ...
        popup = Popup(title=title, content=root, auto_dismiss=True, size=size, size_hint=(None, None))
        popup.open()
